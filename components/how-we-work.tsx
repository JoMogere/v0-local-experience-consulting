  ...
  return (
    <section className="py-16 md:py-24 bg-navy-deep" id="how-we-work">
      <div className="max-w-[1200px] mx-auto px-4 md:px-10">
        <p className="text-clay text-sm uppercase tracking-[2px] mb-4">How We Work</p>
        <h2 className="text-3xl md:text-[42px] font-bold mb-12 tracking-[-0.02em] text-[#F9F6F0]">
          What Actually Happens After You Reach Out
        </h2>

        <div className="grid md:grid-cols-4 gap-6">
          {STEPS.map((step) => (
            <div key={step.number} className="border-t-2 border-gold-flat pt-6">
              <div className="text-gold-flat text-3xl font-bold mb-3">{step.number}</div>
              <h3 className="text-xl font-bold mb-3 text-[#F9F6F0]">{step.title}</h3>
