...
const socialLinks = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/bookedupafrica?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
    icon: (
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@bookedupafrica?is_from_webapp=1&sender_device=pc",
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
