...
const socialLinks = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/localexperienceconsulting/",
    icon: (
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@localexperienceconsultin",
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/local-experience-consulting-8538473b4",
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
  ...
  {
    name: "Facebook",
    href: "https://web.facebook.com/profile.php?id=61555797101970",
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@localexperienceconsulting",
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
  ...
  {
    name: "Substack",
    href: "https://substack.com/@localexperienceconsulting",
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
