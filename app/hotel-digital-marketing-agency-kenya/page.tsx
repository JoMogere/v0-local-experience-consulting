    ...
    <div className="min-h-screen bg-navy-deep text-[#F9F6F0]">
      ...
      <section className="py-20 md:py-32 px-4">
        <div className="max-w-4xl mx-auto">
          <p className="text-gold-flat text-sm uppercase tracking-[2px] mb-4">Hotel Digital Marketing Agency</p>
          ...
          <div className="flex gap-4 flex-wrap">
            <Link href="#why-specialist" className="px-6 py-3 bg-gradient-to-r from-[#D46A43] to-[#E6AD45] text-[#0D0D0D] hover:opacity-90 rounded hover:opacity-90 transition-colors">
      ...
      {/* Why a specialist */}
      <section id="why-specialist" className="py-20 md:py-32 px-4 bg-navy-alt">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="border border-border-flat rounded p-6">
              <h3 className="text-xl font-bold mb-4 text-gold-flat">Source-Market Segmentation</h3>
            ...
            <div className="border border-border-flat rounded p-6">
              <h3 className="text-xl font-bold mb-4 text-gold-flat">Weekly Check-Ins, Not Monthly Reports</h3>
              <p className="text-gray-300 text-sm">
            ...
            <div className="border border-border-flat rounded p-6">
              <h3 className="text-xl font-bold mb-4 text-gold-flat">Direct Support When It Matters</h3>
              <p className="text-gray-300 text-sm">
      ...
      <section className="py-20 md:py-32 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <Link
            ...
            className="block border border-border-flat rounded-sm p-8 hover:border-gold-flat/60 transition-all bg-navy-alt"
          >
            ...
            <span className="text-gold-flat font-semibold">Read the full case study →</span>
          </Link>
        </div>
      </section>
      ...
      <section className="py-20 md:py-32 px-4 bg-navy-alt">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/services/local-seo" className="border border-border-flat rounded p-6 hover:border-gold-flat/50 transition-all block">
              <h3 className="text-xl font-bold mb-4 text-gold-flat">Local SEO</h3>
            ...
            <Link href="/services/direct-bookings" className="border border-border-flat rounded p-6 hover:border-gold-flat/50 transition-all block">
              <h3 className="text-xl font-bold mb-4 text-gold-flat">Direct Bookings</h3>
            ...
            <Link href="/services/experiential-marketing" className="border border-border-flat rounded p-6 hover:border-gold-flat/50 transition-all block">
              <h3 className="text-xl font-bold mb-4 text-gold-flat">Experiential Marketing</h3>
      ...
      <section className="py-20 md:py-32 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Link href="/blog/hotel-marketing-agency-vs-digital-marketing-agency" className="border border-border-flat rounded p-6 hover:border-gold-flat/50 transition-all block">
            ...
            <Link href="/hotel-growth-partnership-kenya" className="border border-border-flat rounded p-6 hover:border-gold-flat/50 transition-all block">
            ...
            <Link href="/blog/how-to-choose-a-hotel-marketing-agency-kenya" className="border border-border-flat rounded p-6 hover:border-gold-flat/50 transition-all block">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center bg-navy-alt border border-border-flat rounded-sm p-12">
          ...
          <Link href="/contact" className="inline-block px-8 py-3 bg-gradient-to-r from-[#D46A43] to-[#E6AD45] hover:opacity-90 text-[#0D0D0D] font-bold rounded-sm transition-colors">
