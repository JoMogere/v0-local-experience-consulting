  ...
  return (
    <main className="min-h-screen bg-navy-deep text-[#F9F6F0] pt-24">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-12 md:py-16">
        <div className="bg-navy-alt border border-border-flat rounded-sm p-8 text-center mb-16">
        ...
        {videos.length === 0 && (
          <div className="text-center py-12 bg-navy-alt border border-border-flat rounded-sm">
        ...
        {debugParam === '1' && (
          <div className="mb-8 p-6 bg-black/60 border border-yellow-500/30 rounded-sm overflow-x-auto">
        ...
        {featured.length > 0 && (
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {featured.map((video) => (
                <div key={video.id} className="bg-navy-alt border border-border-flat rounded-sm overflow-hidden">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {rest.map((video) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group bg-navy-alt border border-border-flat rounded-sm overflow-hidden hover:border-gold-flat/50 transition-colors"
                >
                  <div className="aspect-video relative overflow-hidden bg-black/40">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bg-black/20 group-hover:bg-black/10 transition-colors">
                      <div className="w-14 h-14 bg-gold-flat/90 rounded-full flex items-center justify-center">
                  ...
                  <div className="p-4">
                    <h3 className="font-bold text-sm line-clamp-2 group-hover:text-gold-flat transition-colors">
                      {video.title}
                    </h3>
                  </div>
                </a>
