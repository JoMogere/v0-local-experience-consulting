...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-navy-deep text-[#F9F6F0] pt-32 pb-16">
      <div className="max-w-3xl mx-auto px-4 md:px-6">
        <header className="text-center mb-12">
          <p className="text-gold-flat text-sm uppercase tracking-[2px] mb-4">Free Audit</p>
        ...
        <section className="grid md:grid-cols-2 gap-6 mb-12">
          <div className="bg-navy-alt border border-border-flat rounded-sm p-8">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center w-full px-6 py-3 bg-[#25D366] text-[#F9F6F0] font-bold rounded-sm hover:opacity-90 transition-opacity"
            >
          ...
          <div className="bg-navy-alt border border-border-flat rounded-sm p-8">
            <div className="w-12 h-12 bg-navy-alt rounded-full flex items-center justify-center mb-4">
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-full px-6 py-3 bg-gradient-to-r from-[#D46A43] to-[#E6AD45] text-[#0D0D0D] hover:opacity-90 font-bold rounded-sm hover:opacity-90 transition-colors"
            >
              Claim My Free Call →
            </Link>
          </div>
        ...
        <section className="bg-navy-alt border border-border-flat rounded-sm p-8 text-center">
          ...
          <a href="mailto:mogerejulius41@gmail.com" className="text-gold-flat hover:text-gold-flat font-bold">
